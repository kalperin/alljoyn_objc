...
{    
    @try 
    {
        ...
        //
        self.bus = [[AJNBusAttachment alloc] initWithApplicationName:@"myApp" allowingRemoteMessages:YES];        
        ...
        [self.delegate didReceiveStatusUpdateMessage:@"Bus now connected to launchd:\n"];        
