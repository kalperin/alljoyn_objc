...
NSString * const kBasicObjectServicePath = @"/method_sample";
NSString * const kBasicObjectServiceName = @"org.alljoyn.Bus.method_sample";
NSString * const kBasicObjectInterfaceName = @"org.alljoyn.Bus.method_sample";
