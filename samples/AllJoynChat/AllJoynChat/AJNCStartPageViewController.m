//
//  AJNCStartPageViewController.m
//  AllJoynChat
//
//  Created by  on 8/8/12.
...
- (IBAction)didTouchStartButton:(id)sender 
{
    ...
    if (self.chatSessionTypeSegmentedControl.selectedSegmentIndex == 0) { 
        ...
        //
        [self.busAttachment advertiseName:serviceName withTransportMask:kAJNTransportMaskICE];
        
        AJNSessionOptions *sessionOptions = [[AJNSessionOptions alloc] initWithTrafficType:kAJNTrafficMessages supportsMultipoint:YES proximity:kAJNProximityAny transportMask:kAJNTransportMaskICE];
...
- (IBAction)didTouchStopButton:(id)sender 
{
    ...
    if (self.chatSessionTypeSegmentedControl.selectedSegmentIndex == 0) { 
        ...
        [self.busAttachment cancelAdvertisedName:serviceName withTransportMask:kAJNTransportMaskICE];
    }
